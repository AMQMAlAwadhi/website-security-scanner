"""
Professional Security Report Generator - Burp Suite Style with Enhanced Features
"""
...
class ProfessionalReportGenerator:
    ...
    def _generate_remediation_priorities(self, vulnerabilities: List[Dict]) -> List[Dict]:
        ...
        remediation_list = []
        for i, vuln in enumerate(prioritized[:20], 1):  # Top 20
    ...
    def _generate_enhanced_html(self, results):
        ...
        # This method should be overridden by EnhancedReportGenerator
        # For base class, fall back to standard HTML
...
"""
    ...
    def _generate_platform_specific_findings(self, results):
        ...
        platform_type = platform_analysis.get("platform_type", "unknown")
        ...
        specific_data = platform_analysis.get("specific_findings", {})
...
<h1>Summary</h1>
<span class="TEXT">The table below shows numbers of issues identified in different categories. Issues are classified according to severity as High, Medium, Low or Information. This reflects likely impact of each issue for a typical organization. Issues are also classified according to confidence as Certain, Firm or Tentative. This reflects the inherent reliability of technique that was used to identify issue.</span><br><br>"""
...
"""
    ...
    def _generate_burp_findings(self, results):
        ...
        for i, v in enumerate(vulnerabilities, 1):
            ...
            prev_link = f"<a class=\"PREVNEXT\" href=\"#{prev_anchor_id}\">Previous</a>" if i>1 else ''
            next_link = f"<a class=\"PREVNEXT\" href=\"#{next_anchor_id}\">Next</a>" if i < len(vulnerabilities) else ''
